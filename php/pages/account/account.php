...
<head>
    ...
    <link rel="stylesheet" href="/php/pages/account/account.css">
...
<body>
    ...
    <?php 
    if ($_GET['page'] == "forums")include "../../modules/footer/sticky-footer.php";
    else include "../../modules/footer/footer.php";
    ?>
</body>
